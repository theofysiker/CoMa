...
\author{Samantha Scharmacher\inst{1} (BSC)\\Nicolas Lehmann\inst{2} (Dipl. Kfm., BSC)}
\authorrunning{Samantha Scharmacher \& Nicolas Lehmann} % abbreviated author list (for running head)
\tocauthor{Samantha Scharmacher, Nicolas Lehmann}
